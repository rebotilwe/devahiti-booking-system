...
import longPortraitImg from "../assets/images/about.jpg"; // Using for full-width section
import groupImg from "../assets/images/group.jpg"; // Add image for group class
import corporateImg from "../assets/images/img1.jpg"; // Add image for corporate wellness
import workshopImg from "../assets/images/specialize.jpg"; // Add image for specialized workshop
    ...
    <div className="bg-background">
      ...
      <section className="py-24 px-6 bg-background"> {/* Using your warm off-white background */}
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          {/* Specialised Services - UPDATED with all 6 services */}
          <div>
      ...
      {/* 4. SERVICES GRID - UPDATED with all 6 services (2 rows of 3) */}
      <section className="py-24 px-6">
