...
export const services = [
  ...
  },
  {
    ...
    category: "Sound Healing",
    description:
      "Experience the therapeutic benefits of sound massage. Using singing bowls placed directly on and around the body, this treatment creates deep vibrational healing, releasing tension and promoting cellular restoration.",
  ...
  },
  {
    ...
    description:
      "Hands-on fascial release therapy to relieve tension, improve mobility, and restore balance in the body. This gentle but effective technique targets the connective tissue to release chronic tension patterns.",
  ...
  },
  {
    ...
    category: "Workshops",
    description:
      "Deepen your understanding of yoga philosophy, anatomy, and teaching methodology. These educational workshops are perfect for practitioners and aspiring teachers alike.",
  ...
  },
  {
    ...
    category: "Retreats",
    description:
      "Immerse yourself in a transformative retreat experience. Combining yoga, sound healing, meditation, and wellness activities, our retreats offer a complete reset for mind, body, and spirit.",
  ...
  },
  {
    ...
    category: "Therapeutic Bodywork",
    description:
      "A gentle, non-invasive therapy that stimulates the body's natural healing response. Bowen Therapy addresses pain, stress, and tension by making precise, gentle rolling movements over muscles and connective tissue.",
